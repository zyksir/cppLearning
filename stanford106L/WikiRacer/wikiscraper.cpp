...
unordered_set<string> findWikiLinks(const string& inp) {
    ...
    static const string link_start_delim = "href=\"/wiki/";
    static const char link_end_delim = '\"';

    unordered_set<string> ret;

    auto html_start = inp.begin();
    auto html_end = inp.end();
    ...
    while(true) {
        ...
        auto url_start = std::search(html_start, html_end, link_start_delim.begin(), link_start_delim.end());
        if (url_start == html_end) break;
        html_start = url_start + link_start_delim.length();
        ...
        auto url_end = std::find(html_start, html_end, link_end_delim);
        html_start = url_end + 1;
        // END STUDENT CODE HERE
        ///////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////////////
        // BEGIN STUDENT CODE HERE (delete/edit this line)
        string link = string(url_start + link_start_delim.length(), url_end);
        // END STUDENT CODE HERE
        ///////////////////////////////////////////////////////////////////////////////////////////////////
